...
effect @a slow_falling 35 255 true
effect @a night_vision 99999 50 true
effect @a saturation 1600 255 true
effect @a absorption 999999 20 true
...
setblock 5 316 18 air
setblock 5 316 20 air
setblock 5 316 22 air
