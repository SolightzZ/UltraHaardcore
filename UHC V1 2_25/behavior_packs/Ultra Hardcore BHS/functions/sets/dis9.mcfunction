...
execute @a[scores={gm=7220}] ^^^ fill  -15 60 -15 -15 120 15 red_stained_glass
execute @a[scores={gm=7220}] ^^^ fill  -15 60 -15 15 120 -15 red_stained_glass
execute @a[scores={gm=7220}] ^^^ fill  15 60 -15 15 120 15 red_stained_glass
execute @a[scores={gm=7220}] ^^^ fill  -15 60 15 15 120 15 red_stained_glass
execute @a[scores={gm=7220}] ^^^ fill 15 100 -15 -15 100 15 glass
execute @a[scores={gm=7220}] ^^^ fill fill 30 0 -30 -30 0 30 bedrock
...
execute @a[scores={gm=7240}] ^^^ function rank/list
